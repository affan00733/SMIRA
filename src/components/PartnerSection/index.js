                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-6">
                            <div className="wpo-section-title">
                                ...
                                <p>A network of committed partners and generous donors collaborating with the NGO to amplify its reach and enhance its ability to make a lasting difference</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
