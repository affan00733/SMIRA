                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="wpo-section-title">
                            ...
                            <p>Up-to-the-minute news and updates highlighting the NGO's recent achievements, upcoming projects, and ongoing efforts to drive positive change in the community
</p>
                        </div>
                    </div>
                </div>
